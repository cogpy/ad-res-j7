# Recommendations for Amending Answering Affidavit
...
#### Applicant's Inconsistency - CRITICAL
```markdown
...
- **Responds To:** Respondent identification (opportunity to introduce Responsible Person role)
