...
```json
{
  "strategic_framework": {
    ...
    "key_weaknesses_to_exploit": [
      {
        "weakness": "Material Non-Disclosure in Ex Parte Application",
        "exploitation_strategy": "Systematically demonstrate each material fact Peter failed to disclose, showing court would have refused or modified relief if properly informed",
        "priority": "CRITICAL",
        "evidence_required": [
          "Regulatory appointment letters (Responsible Person)",
          "Settlement agreement with dates",
          "Investment payout documentation",
          "Emails showing Rynette's expanding access",
          "Historical collaborative business records"
        ]
      },
      {
        ...
        "evidence_required": [
          ...
          "Historical transactions without board resolutions",
          "Evidence of Peter's participation in collaborative model",
          "Timeline showing sudden change in position"
        ]
      },
      {
        ...
        "evidence_required": [
          ...
          "Settlement agreement date vs interdict filing date",
          "Investment payout schedule",
          "Evidence businesses continue operating normally"
        ]
      },
      {
        "weakness": "Peter's Own Unilateral Actions Caused Disruption",
        "exploitation_strategy": "Show Peter's actions (card cancellations, system lockouts, Rynette empowerment) caused the very disruptions he now attributes to respondents",
        "priority": "HIGH",
        "evidence_required": [
          "Card cancellation records",
          "System access restriction logs",
          "Evidence of disrupted services",
          "Rynette's expanding access documentation"
        ]
      },
      {
        "weakness": "Characterization of Legitimate Expenses as \"Unexplained\"",
        "exploitation_strategy": "Demonstrate IT expenses are legitimate for international business, Peter restricted access to documentation then claimed it doesn't exist",
        "priority": "MEDIUM-HIGH",
        "evidence_required": [
          "Invoices and contracts for IT services",
          "Evidence of international operations requiring IT infrastructure",
          "Evidence Daniel provided requested documentation",
          "Evidence Peter restricted access to systems containing documentation"
        ]
      }
    ],
    "key_strengths_to_counter": [
      {
        "strength": "Large Monetary Amounts (R8.8M+ IT expenses)",
        "counter_strategy": "Contextualize within international operations across 37 jurisdictions. Show these are legitimate business expenses for global cosmetics regulatory compliance and operations.",
        "priority": "HIGH"
      },
      {
        "strength": "Accountant Identified Discrepancies",
        "counter_strategy": "Show accountant's role is routine tax preparation, not forensic investigation. \"Discrepancies\" are normal documentation requests during tax season, not evidence of misconduct.",
        "priority": "MEDIUM"
      },
      {
        "strength": "Correctly Cites Statutory Provisions",
        "counter_strategy": "Acknowledge legal framework but demonstrate no factual basis for application. Delinquency requires gross misconduct/willful breach - none proven.",
        "priority": "MEDIUM"
      }
    ]
  },
  "high_priority_amendments": [
    {
      "ad_paragraph": "AD PARAGRAPH 7.18 TO 7.20",
      "responds_to": "Peter's allegations regarding R500,000 \"birthday gift\"",
      "current_weakness": "Current response may not adequately contextualize within established director loan account practice",
      "recommended_approach": "EXPLOIT PETER'S INCONSISTENCY",
      "specific_amendments": [
        {
        ...
        {
          "section": "Applicant's Inconsistency - CRITICAL",
    ...
    },
    {
      ...
      "responds_to": "Respondent identification (opportunity to introduce Responsible Person role)",
      "current_weakness": "Current response is minimal admission - misses opportunity to establish critical context",
      "recommended_approach": "ESTABLISH MATERIAL NON-DISCLOSURE",
      "specific_amendments": [
        {
          "section": "Enhanced Respondent Identification",
    ...
    {
      "ad_paragraph": "AD PARAGRAPH 8 TO 8.3",
      "responds_to": "Peter's allegations of unexplained IT expenses",
      "current_weakness": "Current response may not adequately contextualize expenses within international operations",
      "recommended_approach": "CONTEXTUALIZE AND DEMONSTRATE PETER'S RESTRICTION OF ACCESS",
      "specific_amendments": [
        {
          "section": "IT Infrastructure Requirements",
        ...
        {
          "section": "Peter's Restriction of Access - CRITICAL",
    ...
    {
      "ad_paragraph": "AD PARAGRAPH 12 TO 12.1",
      "responds_to": "Peter's allegations of relationship breakdown and deadlock",
      "current_weakness": "May not adequately demonstrate Peter's role in causing breakdown",
      "recommended_approach": "SHOW PETER CAUSED BREAKDOWN THROUGH RYNETTE EMPOWERMENT",
      "specific_amendments": [
        {
          "section": "Historical Collaborative Model",
        ...
        {
          "section": "Systematic Breakdown Caused by Peter",
  ...
  "strategic_guidance": {
    "title": "Strategic Guidance for Affidavit Amendments",
    "overarching_principles": [
      ...
      {
        "principle": "Material Non-Disclosure Undermines Ex Parte Interdict",
        "explanation": "Ex parte relief requires utmost good faith. Peter failed to disclose critical facts.",
      ...
      {
        "principle": "Peter Caused the Problems He Complains About",
        "explanation": "Peter's unilateral actions (card cancellations, system lockouts, Rynette empowerment) created disruptions.",
        "application": "Show causation: Peter acts unilaterally → disruption occurs → Peter blames respondents."
      },
      {
        "principle": "Timing Reveals Ulterior Motive",
        "explanation": "Settlement agreement → 8 days → interdict filing. Investment payout in 9 months.",
        "application": "Timeline demonstrates strategic litigation for control, not genuine concern about misconduct."
      },
      {
        "principle": "Fact-Based Evidence, No Speculation",
        "explanation": "Every allegation must be supported by documentary evidence. Avoid speculation.",
    ...
    "language_guidelines": {
      "avoid": [
        "\"Unauthorized transactions\" (use \"consistent with established practice\")",
      ...
      "use": [
        ...
        "\"Applicant's inconsistent position\"",
        "\"Material non-disclosure in ex parte application\"",
        "\"Systematic breakdown of collaborative model\"",
        "\"Applicant's unilateral actions caused disruption\"",
  ...
  "summary": {
    "total_high_priority_amendments": 4,
    "key_weaknesses_to_exploit": 5,
    "key_strengths_to_counter": 3
  }
}
```
